...
// Example usage:
countryToLiveIn('English', false, 40, 'Finland'); // Output: You should live in Finland.
countryToLiveIn('Spanish', true, 80, 'Spain'); // Output: Spain does not meet your criteria.

/*---------RESULT ----------------------------------------------------

node /tmp/bPEuI1pj66.js
You should live in Finland.
Spain does not meet your criteria.
